  ...
  <div class="row">
    ...
    <nav class="col-md-2 d-none d-md-block sidebar">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ url('/theaters') }}"><i class="bi bi-building me-2"></i>Theaters</a>
        </li>
        <li class="nav-item">
    ...
    <main class="col-md-10 ms-sm-auto px-md-4">
      ...
      <div class="card mt-4 p-3">
        <div class="d-flex justify-content-between mb-3">
          <h5>Theater List</h5>
          <button class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Add Theater</button>
        </div>
