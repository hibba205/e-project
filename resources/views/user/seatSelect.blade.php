...
<head>
	...
	<link href="{{ asset('seatSelection/assets/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
	<script src="{{ asset('seatSelection/assets/js/jquery-1.11.0.min.js') }}"></script>
	<script src="{{ asset('seatSelection/assets/js/jquery.seat-charts.js') }}"></script>
</head>
...
<div class="content">
	...
	<script type="text/javascript" src="{{ asset('seatSelection/assets/js/theme-change-seat-sel.js') }}"></script>
	<script src="{{ asset('seatSelection/assets/js/jquery.nicescroll.js') }}"></script>
	<script src="{{ asset('seatSelection/assets/js/scripts.js') }}"></script>
</body>
