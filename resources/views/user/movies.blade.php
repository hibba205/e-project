				...
				<div class="owl-four owl-carousel owl-theme">
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{ asset('user/assets/images/banner1.jpg') }}" alt="">
								</figure>
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{ asset('user/assets/images/banner2.jpg') }}" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{ asset('user/assets/images/banner3.jpg') }}" alt="">
								</figure>
								<div class="box-content">
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="{{ asset('user/assets/images/banner4.jpg') }}" alt="">
								</figure>
								<div class="box-content">
			...
			<div class="container py-lg-4">
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/commando3.png') }}" alt="">
							</figure>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/commando3.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m3.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Knivesout" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m3.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/bharat1.png') }}" alt="">
							</figure>
							...
							<div class="modal fade Bharat" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/bharat1.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m5.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Jumanji" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m5.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m1.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Rocketman" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m1.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m2.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Doctorsleep" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m2.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/ks1.png') }}" alt="">
							</figure>
							...
							<div class="modal fade kabir" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/ks1.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m9.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Joker" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m9.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/tzp.png') }}" alt="">
							</figure>
							...
							<div class="modal fade tzp" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/tzp.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/cp.png') }}" alt="">
							</figure>
							...
							<div class="modal fade Chillarparty" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/cp.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/ganesha.png') }}" alt="">
							</figure>
							...
							<div class="modal fade ganesha" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/ganesha.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/m8.jpg') }}" alt="">
							</figure>
							...
							<div class="modal fade Toystory" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/m8.jpg') }}" class="img-fluid modalimg" alt="" />
											<p>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/gk.png') }}" alt="">
							</figure>
							...
							<div class="modal fade gk" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/gk.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/gujjubhai.jpeg') }}" alt="">
							</figure>
							...
							<div class="modal fade gujjubhai" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/gujjubhai.jpeg') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/Thaijase.png') }}" alt="">
							</figure>
							...
							<div class="modal fade thaijase" id="myModal" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/Thaijase.png') }}" class="img-fluid modalimg" alt="" />
											<p>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<figure>
								<img class="img-fluid" src="{{ asset('user/assets/images/reva.png') }}" alt="">
							</figure>
							...
							<div class="modal fade Reva" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content" id="mymodalcontent">
										...
										<div class="modal-body" id="dynamic-content">
											<img src="{{ asset('user/assets/images/reva.png') }}" class="img-fluid modalimg" alt="" />
											<p>
							...
							<div class="albums-content">
								<div class="row">
										...
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html">
													...
													<img src="{{ asset('user/assets/images/m6.jpg') }}" class="img-fluid"
														alt="author image">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m5.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m4.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m1.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m2.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m3.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/n1.jpg') }}" class="img-fluid"
														alt="author image">
													<span class="fa fa-play video-icon" aria-hidden="true"></span>
												</a>
											</div>
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/n2.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/n3.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m7.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m8.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m9.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
							...
							<div class="albums-content">
								<div class="row">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m10.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m11.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
									...
									<div class="col-lg-4 new-relise-gd mt-lg-0 mt-0">
										<div class="slider-info">
											<div class="img-circle">
												<a href="movies.html"><img src="{{ asset('user/assets/images/m12.jpg') }}" class="img-fluid"
														alt="author image">
													<div class="overlay-icon">
