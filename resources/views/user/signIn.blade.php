...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('user/assets/css/sign-in.css') }}">
</head>
...
<body>
    ...
    <div class="form-container sign-up-container">
        <form method="POST" action="{{ url('/signIn') }}">
            ...
            <div><input name="password" type="password" placeholder="Enter Your Password"/>
            <span class="text-danger">
                 @error("password")
                     {{ $message }}
                 @enderror
    ...
    <form method="POST" action="{{ url('/sign_in') }}" style="color: var(--theme-title);">
        @csrf
        <h1>Sign in</h1>
        <div class="social-container">
	...
	<!-- <script type="text/javascript" src="{{ asset('user/assets/js/as-alert-message.min.js') }}"></script> -->
	...
	<script type="text/javascript" src="{{ asset('user/assets/js/sign-in.js') }}"></script>
